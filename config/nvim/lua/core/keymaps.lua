...
vim.keymap.set('n', '<leader>fa', '<cmd>Telescope autocommands<cr>', { desc = 'Find autocommand' })
vim.keymap.set('n', '<leader>fF', '<cmd>Telescope find_files follow=true no_ignore=true hidden=true<cr>', { desc = 'Find (all) file' })
...
vim.keymap.set('n', '<leader>fgL', '<cmd>Telescope git_commits<cr>', { desc = 'Find commit' })
vim.keymap.set('n', '<leader>fgb', '<cmd>Telescope git_branches<cr>', { desc = 'Find branch' })
vim.keymap.set('n', '<leader>fgl', '<cmd>Telescope git_bcommits<cr>', { desc = 'Find buffer commit' })
vim.keymap.set('n', '<leader>fgz', '<cmd>Telescope git_stash<cr>', { desc = 'Find stash' })
vim.keymap.set('n', '<leader>fgs', '<cmd>Telescope git_status<cr>', { desc = 'Find status' })
