...
vim.keymap.set('n', '<leader>fo', '<cmd>Telescope oldfiles only_cwd=true<CR>', { desc = 'Find (cwd) oldfile' })
vim.keymap.set('n', '<leader>fO', '<cmd>Telescope oldfiles only_cwd=false<CR>', { desc = 'Find (all) oldfile' })
